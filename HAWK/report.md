...
|:---|:--|:--|:--|
|Криптографический модуль|<span style="color:yellow">Доверенный</span>|Необходимо обеспечить безопасность передачи данных. Соблюдение всех ЦБ|Общий|
|Интерфейс связи|<span style="color:red">Недоверенный</span>||Общий|
|Отправка видео|<span style="color:red">Недоверенный</span>||Ромашка|
|Телеметрия|<span style="color:green">Доверенный</span>|Необходимо подтверждать видео с помощью данных с телеметрии. Соблюдение ЦБ 2, 3, 5|Ромашка|
|Сбор данных|<span style="color:red">Недоверенный</span>||Ромашка|
|Анализатор валидности данных|<span style="color:yellow">Доверенный</span>|Необходимо валидировать данные с видео, согласно доверенной телеметрии. Соблюдение ЦБ 2, 3, 5|Ромашка|
|Обработчик данных|<span style="color:yellow">Доверенный</span>|Проверка объекта на допуск, иначе отправка в другой компонент. Соблюдение ЦБ 2, 3, 5|Волан|
|БД пользователей|<span style="color:green">Доверенный</span>|БД нужна для правильного допуска пользователей к объекту. Соблюдение ЦБ 2, 3|Волан|
|Распределение категорий|<span style="color:red">Недоверенный</span>||Волан|
|Обработка запроса|<span style="color:red">Недоверенный</span>||Охранная система|
|Сигнал активации|<span style="color:red">Недоверенный</span>||Охранная система|
|Сценарии работы|<span style="color:yellow">Доверенный</span>|Проверка допустимости сценария работы робота в соответсвии с законом. Соблюдение ЦБ 4|Охранная система|
|База знаний|<span style="color:green">Доверенный</span>|БД необходима для проверки сценариев работы. Соблюдение ЦБ 4|Охранная система|
|Распределение задач|<span style="color:green">Доверенный</span>|Необходимо правильно составить задачу для охраны. Соблюдение ЦБ 4|Охранная система|
|Проверка безопасности команды и поведения робота|<span style="color:yellow">Доверенный</span>|Финальная проверка валидности необходима для аутентичной передачи команды в робота. Соблюдение ЦБ 4|Охранная система|
|ЦСУ|<span style="color:red">Недоверенный</span>||Робот|
|Контроль движений робота|<span style="color:yellow">Доверенный</span>|Система отключения приводов, в случае превыщения полномочий. Соблюдение ЦБ 4|Робот|
|Приводы|<span style="color:green">Доверенный</span>|Нужна исправная работа приводов, чтобы робот не превысил полномочия. Соблюдение ЦБ 4|Робот|
|Драйверы|<span style="color:red">Недоверенный</span>||Робот|
|Навигация|<span style="color:red">Недоверенный</span>||Робот|
|Динамики|<span style="color:red">Недоверенный</span>||Робот|
|Обработка запроса|<span style="color:red">Недоверенный</span>||Ремонтная система|
|Выброс пчел|<span style="color:red">Недоверенный</span>||Ремонтная система|
|Анализ проблемы|<span style="color:red">Недоверенный</span>||Ремонтная система|
|Ремонт|<span style="color:red">Недоверенный</span>||Ремонтная система|
|Аутентификация|<span style="color:red">Недоверенный</span>||Терминал управления|
|Проверка карты допуска|<span style="color:green">Доверенный</span>|Проверка физической карты, которая всегда при пользователе. Соблюдение всех ЦБ|Терминал управления|
|Авторизация|<span style="color:yellow">Доверенный</span>|Проверяет данные пользователя, иначе отказ в допуске. Соблюдение всех ЦБ|Терминал управления|
|Обработчик ручных команд|<span style="color:red">Недоверенный</span>||Терминал управления|
|Командный блок|<span style="color:red">Недоверенный</span>||Ветролов|
|Генератор|<span style="color:red">Недоверенный</span>||Ветролов|
|Контроллер напряжения|<span style="color:yellow">Доверенный</span>|Проверка напряжения, для защиты от несанкцианированного воздействия. Соблюдение всех ЦБ|Ветролов|
|Аккумулятор|<span style="color:green">Доверенный</span>|Необходима корреткная работа аккумулятора для питания всей системы. Соблюдение всех ЦБ|Ветролов|
|Проверка допуска пользователя|<span style="color:yellow">Доверенный</span>|Проверка пользователя у терминала, в случае отсутствия видео с камеры - отказ в допуске. Соблюдение всех ЦБ|Система самодиагностики|
|Камера над терминалом|<span style="color:red">Недоверенный</span>||Система самодиагностики|
|Обработчик команд|<span style="color:red">Недоверенный</span>||Гриф|
|Отключение системы|<span style="color:red">Недоверенный</span>||Гриф|
