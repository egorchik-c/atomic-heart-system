...
|--|--|--|--|
| Криптографический модуль      | 🟡 Доверенный         | Необходимо обеспечить безопасность передачи данных. Соблюдение всех ЦБ | Общий |
| Интерфейс связи               | 🔴 Недоверенный       |             | Общий              |
| Отправка видео                | 🔴 Недоверенный       |             | Ромашка            |
| Телеметрия                    | 🟢 Доверенный         | Необходимо подтверждать видео с помощью данных с телеметрии. Соблюдение ЦБ 2, 3, 5 | Ромашка |
| Сбор данных                   | 🔴 Недоверенный       |             | Ромашка            |
| Анализатор валидности данных  | 🟡 Доверенный         | Необходимо валидировать данные с видео, согласно доверенной телеметрии. Соблюдение ЦБ 2, 3, 5 | Ромашка |
| Обработчик данных             | 🟡 Доверенный         | Проверка объекта на допуск, иначе отправка в другой компонент. Соблюдение ЦБ 2, 3, 5 | Волан |
| БД пользователей              | 🟢 Доверенный         | БД нужна для правильного допуска пользователей к объекту. Соблюдение ЦБ 2, 3 | Волан |
| Распределение категорий       | 🔴 Недоверенный       |             | Волан              |
| Обработка запроса             | 🔴 Недоверенный       |             | Охранная система   |
| Сигнал активации              | 🔴 Недоверенный       |             | Охранная система   |
| Сценарии работы               | 🟡 Доверенный         | Проверка допустимости сценария работы робота в соответствии с законом. Соблюдение ЦБ 4 | Охранная система |
| База знаний                   | 🟢 Доверенный         | БД необходима для проверки сценариев работы. Соблюдение ЦБ 4 | Охранная система |
| Распределение задач           | 🟢 Доверенный         | Необходимо правильно составить задачу для охраны. Соблюдение ЦБ 4 | Охранная система |
| Проверка безопасности команды | 🟡 Доверенный         | Финальная проверка валидности необходима для аутентичной передачи команды в робота. Соблюдение ЦБ 4 | Охранная система |
| ЦСУ                           | 🔴 Недоверенный       |             | Робот              |
| Контроль движений робота      | 🟡 Доверенный         | Система отключения приводов, в случае превышения полномочий. Соблюдение ЦБ 4 | Робот |
| Приводы                       | 🟢 Доверенный         | Нужна исправная работа приводов, чтобы робот не превысил полномочия. Соблюдение ЦБ 4 | Робот |
| Драйверы                      | 🔴 Недоверенный       |             | Робот              |
| Навигация                     | 🔴 Недоверенный       |             | Робот              |
| Динамики                      | 🔴 Недоверенный       |             | Робот              |
| Обработка запроса             | 🔴 Недоверенный       |             | Ремонтная система  |
| Выброс пчел                   | 🔴 Недоверенный       |             | Ремонтная система  |
| Анализ проблемы               | 🔴 Недоверенный       |             | Ремонтная система  |
| Ремонт                        | 🔴 Недоверенный       |             | Ремонтная система  |
| Аутентификация                | 🔴 Недоверенный       |             | Терминал управления |
| Проверка карты допуска        | 🟢 Доверенный         | Проверка физической карты, которая всегда при пользователе. Соблюдение всех ЦБ | Терминал управления |
| Авторизация                   | 🟡 Доверенный         | Проверяет данные пользователя, иначе отказ в допуске. Соблюдение всех ЦБ | Терминал управления |
| Обработчик ручных команд      | 🔴 Недоверенный       |             | Терминал управления |
| Командный блок                | 🔴 Недоверенный       |             | Ветролов           |
| Генератор                     | 🔴 Недоверенный       |             | Ветролов           |
| Контроллер напряжения         | 🟡 Доверенный         | Проверка напряжения, для защиты от несанкционированного воздействия. Соблюдение всех ЦБ | Ветролов |
| Аккумулятор                   | 🟢 Доверенный         | Необходима корректная работа аккумулятора для питания всей системы. Соблюдение всех ЦБ | Ветролов |
| Проверка допуска пользователя | 🟡 Доверенный         | Проверка пользователя у терминала, в случае отсутствия видео с камеры - отказ в допуске. Соблюдение всех ЦБ | Система самодиагностики |
| Камера над терминалом         | 🔴 Недоверенный       |             | Система самодиагностики |
| Обработчик команд             | 🔴 Недоверенный       |             | Гриф               |
| Отключение системы            | 🔴 Недоверенный       |             | Гриф               |
